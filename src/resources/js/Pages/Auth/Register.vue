...
const props = defineProps({
    customFields: Array,
    // REMOVIDO: A prop 'bairros' foi removida, pois será buscada dinamicamente.
});
...
const form = useForm({
 ...
    privacy: false,
    cpf: '',
    // ATUALIZADO: Este campo irá guardar o ID (se numérico) ou o NOME (se novo) do bairro.
    bairro_id: null,
...
// --- LÓGICA DE AUTOCOMPLETE DO BAIRRO (ADICIONADA) ---
...
const searchBairros = async (term, loading) => {
    try {
        // Usa a rota pública 'public.bairros.search'
...
// ATUALIZADO: Agora valida se um bairro_id foi selecionado (ou um novo foi digitado).
const validateStep3 = () => {
