...
defineProps({
    ...
    // ATUALIZADO: Prop para receber as opções de bairros dinamicamente.
    bairrosOptions: Array,
});

// ATUALIZADO: Adicionado o emit para o evento de busca.
const emit = defineEmits(['buscar-cep', 'search-bairros']);

// ATUALIZADO: Handler para emitir o evento de busca para o componente pai.
...
<template>
    ...
    <div class="grid grid-cols-1 md:grid-cols-6 gap-x-6 gap-y-6">
        ...
        <div class="input-container md:col-span-4">
            ...
            >
                <template #no-options>
                    Nenhum bairro encontrado. Digite ao menos 3 letras.
                </template>
            </v-select>
