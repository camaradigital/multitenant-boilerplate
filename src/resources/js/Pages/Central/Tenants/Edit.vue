...
const form = useForm({
    ...
    endereco_cep: props.tenant.endereco_cep,
    endereco_logradouro: props.tenant.endereco_logradouro,
    endereco_numero: props.tenant.endereco_numero,
    endereco_complemento: props.tenant.endereco_complemento,
...
<template>
    ...
    <AppLayout :title="'Editar ' + form.nome">
        ...
        <div class="flex justify-center items-start py-12 px-4">
            <form @submit.prevent="updateTenant" class="content-container w-full max-w-3xl">

                <div class="form-icon">
                    <Pencil :size="32" class="icon-in-badge" />
                </div>

                <div class="p-6 md:p-8">
                    <div class="text-center mb-8">
                        <h2 class="header-title">Editar Informações da Câmara</h2>
                        <p class="form-subtitle">Altere os dados conforme necessário.</p>
                    </div>
